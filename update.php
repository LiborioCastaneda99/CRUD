        ...
        <div class="table-wrapper">
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					...
					$res = $clientes->update($nombres, $apellidos, $telefono, $direccion, $correo_electronico, $profesion,$id_cliente);
					if($res){
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<textarea  name="profesion" id="profesion" class='form-control' maxlength="100" required><?php echo $datos_cliente->profesion;?></textarea>
				</div>
